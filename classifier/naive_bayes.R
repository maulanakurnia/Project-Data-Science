...
convert_term_matrix <- function(corpus,features){
  return(DocumentTermMatrix(corpus, control = list(dictionary = features)))
}
...
train_model <- function() {
  ...
  data.source <- read_delim("training.txt", delim = "\t")
